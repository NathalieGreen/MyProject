...
public class Game implements ActionListener
{
    ...
    ImageIcon blank = new ImageIcon("blank.jpg"); //creates a new icon for
    ...
    public void checkButton(Object button) throws IOException {
        ...
        /**solves the puzzle by moving every icon to the correct location if solve is pressed.*/
        if (button == solve) {
            buttonsArray[0].setIcon(blank);
            buttonsArray[1].setIcon(iconArray[0]);
            buttonsArray[2].setIcon(iconArray[1]);
            buttonsArray[3].setIcon(iconArray[2]);
            buttonsArray[4].setIcon(iconArray[3]);
            buttonsArray[5].setIcon(iconArray[4]);
            buttonsArray[6].setIcon(iconArray[5]);
            buttonsArray[7].setIcon(iconArray[6]);
            buttonsArray[8].setIcon(iconArray[7]);
            buttonsArray[9].setIcon(iconArray[8]);
            buttonsArray[10].setIcon(iconArray[9]);
            buttonsArray[11].setIcon(iconArray[10]);
            currentscore++;
        }
        ...
        /**if all of the images are in the correct locations, print you win and run the highscores table class!*/
        if (buttonsArray[0].getIcon().toString().equals("blank.jpg") &&
                buttonsArray[1].getIcon().toString().equals("bart0.jpg") &&
                buttonsArray[2].getIcon().toString().equals("bart1.jpg") &&
                buttonsArray[3].getIcon().toString().equals("bart2.jpg") &&
                buttonsArray[4].getIcon().toString().equals("bart3.jpg") &&
                buttonsArray[5].getIcon().toString().equals("bart4.jpg") &&
                buttonsArray[6].getIcon().toString().equals("bart5.jpg") &&
                buttonsArray[7].getIcon().toString().equals("bart6.jpg") &&
                buttonsArray[8].getIcon().toString().equals("bart7.jpg") &&
                buttonsArray[9].getIcon().toString().equals("bart8.jpg") &&
                buttonsArray[10].getIcon().toString().equals("bart9.jpg") &&
                buttonsArray[11].getIcon().toString().equals("bart10.jpg") &&
                !won) {
